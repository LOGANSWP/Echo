...
> **最后同步**：2026-09-07，ADR-023 明确 4.0k 审批、token/执行预算、逐层来源、语言降级、恢复与实机证据
...
| Phase 4 叙事调度（4.0j）与真实生成（4.0k） | architecture + testing + US-SYN-001/002/003/004 AC 原文 + ADR-009/011/017/020/021/022/023 + Creation report-library State/Action Contracts + acceptance policy；4.0j 核对持久开关/独立 eligibleFrom、完整周期/冻结时区、CAS、report/source、原子 publication、noData/L2/BG/D-005 及 generator=nil 零 claim；4.0k 核对具体工件审批、token/执行预算、逐层来源、typed语言降级、恢复重放、真实生产E2E与实机证据 |
