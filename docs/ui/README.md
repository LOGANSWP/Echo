...
| Phase 4 叙事调度（4.0j） | architecture + testing + US-SYN-004 AC 原文 + ADR-011/017/021 + Creation report-library State/Action Contracts + acceptance policy；重点核对默认开启的持久开关与月/年各自独立的 eligibleFrom 基线、重新启用互不截断、完整周期与冻结时区、单周期 CAS、持久 report/source、原子 publication、noData、L2 手动重试、BG expiration 与 D-005 |
