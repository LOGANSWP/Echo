...
| SYN-004 | Partial | 3F.0, 3F.9, 4.0i, 4.0j, 4.2 | 4.0i owns provenance-honest report citations and authorized share handoff. Per ADR-021, 4.0j owns persisted monthly/yearly switches (new-install default on), independent monthly/yearly eligibleFrom baselines, completed-calendar periods with frozen timezone bounds, one-period CAS claiming, bounded aggregation, persistent report/source relations, atomic completion+audit publication, noData/manual-L2 states, opportunistic BGProcessingTask handling, and D-005 invalidation. Re-enabling one type cannot change the other's baseline. Fixture reports are not production evidence. |
