...
| AWK-005 | Partial | 3F.7, 3F.8, 4.0d, 4.0h, 4.0i, 4.2 | 4.0d owns real card media/music/feelings and card→typed-Focus routing. ADR-019 assigns typed Focus source resolution and PhotoKit deletion capability to 4.0h; Share audio is transcript-only because the original is not persisted. 4.0i owns verified source-anchor navigation, and 4.2 verifies the joined loop. |
