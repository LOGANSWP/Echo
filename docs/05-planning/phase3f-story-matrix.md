...
| PRV-007 | Partial | 3F.0, 3F.4, 4.0h, 4.2, 4.5, 4.9 | ADR-019 replaces the impossible five-second wall-clock promise with verifiable PhotoKit delivery/full-scope reconciliation and recoverable D-005 cleanup. Share Extension originals remain unobservable; limited-hidden is not deletion evidence. |
